      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <ModalBody>
          ...
          <div className="flex flex-col gap-3">
            <label
              ...
              className="font-body text-sm text-fg-1 leading-[1.5]"
            >
              Type{' '}
              <code className="font-mono text-xs font-semibold text-fg-0 bg-bg-0 px-1.5 py-px">
                {project.name}
              </code>{' '}
              to confirm.
            </label>
            <input
              ...
              spellCheck={false}
              className={clsx(
                'w-full px-4 h-12 outline-none bg-bg-0 font-mono text-sm text-fg-0 border transition-colors duration-100 disabled:opacity-50',
        ...
        <ModalFooter>
          ...
          <button
            type="submit"
            disabled={!canSubmit}
            className="flex-1 h-14 bg-error text-white font-display font-bold text-xs uppercase tracking-wider hover:opacity-90 transition-opacity duration-100 disabled:opacity-40 disabled:cursor-not-allowed"
          >
